...
if __name__ == "__main__":
    ...
    use_default_center_bias = options.get("center_prior", "default") == "default"
    ...
    def compute_saliency(image_path):
        if use_default_center_bias:
            ...
            get_unbiased_output = K.function(
                [model.layers[0].input, K.learning_phase()], [model.layers[21].output]
            )
        ...
        sm = postprocess_predictions(
            sm, original_image.shape[0], original_image.shape[1]
        )
        return sm
