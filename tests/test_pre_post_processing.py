...
class TestPrePostProcessing(unittest.TestCase):
    def setUp(self):
        ...
        self.parameter_struct = self.parameter_map.get_matlab_struct(self.matlab_engine)

        self.img_matlab = utils.load_image_matlab(self.img_path, self.matlab_engine)
    ...
    def _assert_parameter_equivalence(self, key, value):
        ...
        img_py = utils.python_pre_and_post(self.img_python, self.parameter_dict)
    ...
    def test_cli_and_matlab_equivalence(self):
        ...
        shell_image = utils.saliency_via_shell_interface(algorithm_name, self.img_path)
